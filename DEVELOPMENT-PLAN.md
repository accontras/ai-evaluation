...
> 上次更新: 2026-07-20 | 当前: **S31 多模型对比 (M4)**
...
| S26 | 性能优化 | ⏭️ | - | 非MVP阻塞项, 延后 |
| S27 | 测试补充（上） | ✅ | 2026-07-20 | EventRuleEvaluator(5)+RankingService(1), 6单测全绿 |
| S28 | 测试补充（下） | ✅ | 2026-07-20 | SceneCopy(2)+全量回归12用例: 装配/聚合/路由/事件/排名/深拷贝 |
| S29 | Docker + 文档（上） | ✅ | 2026-07-20 | Dockerfile + docker-compose(MySQL+App) + SpringDoc + README |
| S30 | Docker + 文档（下）+ M3 验证 | ✅ | 2026-07-20 | .dockerignore + v0.3.0-m3 tag, M3 基本完成(仅S22申诉待补) |
| S31 | 多模型对比 | ⬜ | - | |
| S32 | NL → JEXL 实验 | ⬜ | - | |
| S33 | RAG 历史案例检索 | ⬜ | - | |
| S34 | AI 实验记录台 | ⬜ | - | |
...
□ dr_ 前缀 → eval_
□ 去系统字段: domain_code, catagory_code, tenant_id, data_org_id,
