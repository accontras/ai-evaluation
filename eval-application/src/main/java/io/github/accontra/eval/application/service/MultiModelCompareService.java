...
public class MultiModelCompareService {
    ...
    public MultiModelCompareService(LlmScoringStrategy primaryScoring,
        ...
        this.glmScoring = new LlmScoringStrategy(glmClient, standardMapper, indicatorLogMapper, experimentMapper, null, null, null, null);
        this.qwenScoring = new LlmScoringStrategy(qwenClient, standardMapper, indicatorLogMapper, experimentMapper, null, null, null, null);
    }
